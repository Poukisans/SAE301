<div class="container-fluid">
    ...
    <div class="my-3 d-flex flex-row justify-content-end">
        <!-- Acceder a -->
        <a href="<?= BASE_URL ?>contact" role="button" target="_blank" class="btn btn-primary h-100"> <i class="fas fa-external-link-alt mx-1"></i> &nbsp; Voir la page</a>
    </div>
                    ...
                    <div class="d-flex flex-column flex-fill">
                        ...
                        <div class="d-flex flex-row flex-fill">
                            <div class="d-flex flex-column justify-content-end mx-3 mb-2 flex-fill">
                                ...
                                <input name="contact_title" value="<?= $contactInfo['contact_title'] ?>" required class="form-control" type="text">
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-row flex-fill">
                            <div class="d-flex flex-column justify-content-end mx-3 mb-2 flex-fill">
                                <label for="contact">Informations contact</label>
                                <textarea name="contact" class="summernote"><?= $contactInfo['contact'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
